...
#import "NSArray+GYCommon.h"

@implementation NSArray (GYCommon)
...
- (void)exportToPath:(NSString *)path behavior:(GYFileOpertaionBehavior)behavior {
    ...
    [GYFoundationManager exportToPath:path string:self.stringValue continueWhenExist:continueWhenExist showSuccessLog:showSuccessLog];
}
